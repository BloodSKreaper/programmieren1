...
public class LoesungDiagonalen extends JFrame {
	...
	/** 
	 * Bitte den gegebenen Code unten aus der Methode meinPaint 
	 * der Klasse LoesungsBeispiel so abändern, dass:
	 * <ol>
	 * <li> Das Rechteck komplett und in schwarz gemalt wird.							</li>
	 * <li> Die Diagonale von links oben nach rechts unten in rot gezeichnet wird. 		</li>
	 * <li> Die Diagonale von rechts oben nach links unten in blau gezeichnet wird.		</li>
	 * </ol>			
	 * 
     *  @param g Grafik, auf die gezeichnet wird.
	 */
